...
r1 = np.loadtxt('./models/model_steps40_epoch100-v1/win_history.txt')
r2 = np.loadtxt('./models/model_steps60_epoch100-v1/win_history.txt')
r3 = np.loadtxt('./models/model_steps80_epoch100-v1/win_history.txt')
